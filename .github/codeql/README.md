# CodeQL Setup for deepiri-sugar-glider
...
- `.github/workflows/codeql.yml`
  - Defines when scans run and how GitHub Actions executes CodeQL for Go code.
- `.github/codeql/codeql-config.yml`
  - Defines what folders to include and ignore during analysis, tailored for this Go repository.
...
with:
  languages: go
```
This workflow currently runs analysis for Go.
...
2. **Keep language list explicit.**  
   Only include languages with meaningful source code (Go for this repo).
...
This workflow currently analyzes Go only:
